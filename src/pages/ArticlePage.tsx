    ...
    return (
        <div className="min-h-screen bg-neutral-50">
            ...
            <article>
                ...
                <div className="relative w-full h-60 sm:h-72 md:h-80 lg:h-96 xl:h-[30rem] 2xl:h-[34rem] overflow-hidden">
                    <img
                    ...
                    <div className="absolute bottom-0 left-0 right-0">
                        <div className="container-page pb-9 lg:pb-14">
                            ...
                            <h1 className="font-display text-[1.75rem] md:text-4xl lg:text-5xl xl:text-[3.5rem] font-bold text-white leading-[1.08] max-w-4xl">
                                {article.title}
                            </h1>
                        </div>
                    </div>
                ...
                <div className="bg-white border-b border-neutral-200 sticky top-0 z-30">
                    <div className="container-page py-3 flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-300 hidden sm:block">Share</span>
                            {[
                ...
                <div className="container-page py-12 lg:py-16">
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-8">
                            {/* Excerpt Lead */}
                            <p className="font-display text-xl lg:text-[1.6rem] text-neutral-700 leading-relaxed mb-10 border-l-4 border-primary pl-6">
                                {article.excerpt}
                            </p>
                            ...
                            <div className="mt-12 p-6 bg-white border border-neutral-200">
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                    <div className="flex items-center flex-wrap gap-2">
                                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400">Tags</span>
                                        <span
                                        ...
                                        <span className="px-3 py-1 text-[11px] font-bold uppercase tracking-wider bg-neutral-100 text-neutral-500 rounded-sm">India</span>
                                        <span className="px-3 py-1 text-[11px] font-bold uppercase tracking-wider bg-neutral-100 text-neutral-500 rounded-sm">2026</span>
                                    </div>
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-4">
                                {prevArticle ? (
                                    <Link to={`/article/${prevArticle.id}`} className="group p-5 bg-white border border-neutral-200 hover:border-primary/30 hover:shadow-sm transition-all">
                                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400 flex items-center gap-1 mb-2">
                                ...
                                {nextArticle ? (
                                    <Link to={`/article/${nextArticle.id}`} className="group p-5 bg-white border border-neutral-200 hover:border-primary/30 hover:shadow-sm transition-all text-right">
                                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-400 flex items-center gap-1 justify-end mb-2">
                            ...
                            <div className="sticky top-24 space-y-6">
                                <div className="bg-white border border-neutral-200">
                                    <div className="px-5 py-4 border-b border-neutral-200">
                                        <h2 className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary">Related Stories</h2>
                                    </div>
                                        ...
                                        {relatedArticles.map((related) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="text-sm font-semibold text-secondary line-clamp-2 group-hover:text-primary transition-colors leading-snug">
                                                        {related.title}
                                                    </h3>
                                ...
                                <div className="bg-secondary p-6">
                                    <h2 className="font-display text-lg font-bold text-white mb-2">Stay Updated</h2>
                                    ...
                                    />
                                    <button className="w-full py-2.5 bg-primary hover:bg-primary-dark text-white text-[11px] font-bold uppercase tracking-[0.2em] transition-colors">
                                        Subscribe
                                    </button>
                                </div>
                            </div>
                ...
                <section className="bg-white border-t border-neutral-200" aria-label={`More in ${category?.name}`}>
                    <div className="container-page py-16">
                        <div className="flex items-end justify-between mb-8">
                            ...
                            {category && (
                                <Link to={`/category/${category.slug}`} className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary hover:text-primary-dark transition-colors flex items-center gap-1.5">
                                ...
                                >
                                    <div className="relative h-52 overflow-hidden">
                                        ...
                                        <div className="absolute top-4 left-4">
                                            <span className="px-2.5 py-1 bg-white/90 backdrop-blur category-badge">{related.category}</span>
                                        </div>
                                    </div>
                                    <div className="p-6">
                                        <h3 className="font-display font-bold text-lg text-secondary line-clamp-2 group-hover:text-primary transition-colors leading-snug">
                                            {related.title}
                                        </h3>
